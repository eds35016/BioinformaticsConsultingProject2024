...
count_dir <- "/scratch/bioconsult/Ethan_James/BINF_Consulting_2024/ongoing/mapping/PRRSV2/PRRSV2"
out_dir <- "/scratch/bioconsult/Ethan_James/BINF_Consulting_2024/ongoing/DE/STAR_counts/PRRSV2_adjusted_postQC"
...
count_matrix <- read.csv(file.path(count_dir, "adjusted_gene_counts_STAR_postQC.csv"), row.names = 1)
