...
IN_DIR="/scratch/bioconsult/Ethan_James/BINF_Consulting_2024/raw_data/${RUN_NAME}"
...
sbatch --array=1-${#SAMPLE_IDS[@]}%10 --export=RUN_NAME=${RUN_NAME},RUN_ID=${RUN_ID},GENOME_DIR=${GENOME_DIR},SAMPLE_IDS_STR="${SAMPLE_IDS_STR}",IN_DIR=${IN_DIR},OUT_DIR=${OUT_DIR},METADATA_FILE=${METADATA_FILE} salmon_align.sbatch
