...
# Define variables
RUN_NAME="PRRSV2_134_QUANT"
FASTA_DIR_NAME="PRRSV2"
RUN_ID="CKDL210021614-1a-AK7207-AK7213_HMH2WDSX2"
GENOME_DIR="/scratch/bioconsult/Ethan_James/BINF_Consulting_2024/ongoing/mapping/STAR_idx/${FASTA_DIR_NAME}/pig_PRRSV2_134"
...
sbatch --array=1-${#SAMPLE_IDS[@]}%12 --export=RUN_NAME=${RUN_NAME},RUN_ID=${RUN_ID},GENOME_DIR=${GENOME_DIR},SAMPLE_IDS_STR="${SAMPLE_IDS_STR}",IN_DIR=${IN_DIR},OUT_DIR=${OUT_DIR},METADATA_FILE=${METADATA_FILE} STAR_align_134.sbatch
