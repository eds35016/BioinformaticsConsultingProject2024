...
# set up reference genome index
        ...
        viralseqdir="/scratch/bioconsult/Ethan_James/BINF_Consulting_2024/raw_data/ref_genomes/PRRSV2/NC174"

        idxdir="/scratch/bioconsult/Ethan_James/BINF_Consulting_2024/ongoing/mapping/STAR_idx/PRRSV2/pig_PRRSV2_174"

        $star --runThreadN 8 --runMode genomeGenerate --genomeDir $idxdir \
                --genomeFastaFiles $refseqdir/GCF_000003025.6_Sscrofa11.1_genomic.fna $viralseqdir/NC18-9-7.fa \
                --sjdbGTFfile $viralseqdir/combined_pig_NC174.gtf \
                --sjdbOverhang 149
